...
Float3::Float3(int32_t x_, int32_t y_, int32_t z_)
{
    x = float(x_);
    y = float(y_);
    z = float(z_);
...
Uint2::Uint2(uint32_t x_) : x(x_), y(x_)
{
}
...
Uint2::Uint2(const Float2& v) : x(uint32_t(v.x)), y(uint32_t(v.y))
{
}
...
Uint3::Uint3(uint32_t x_) : x(x_), y(x_), z(x_)
{
}
...
Uint3::Uint3(const Float3& v) : x(uint32_t(v.x)), y(uint32_t(v.y)), z(uint32_t(v.z))
{
}
...
Uint4::Uint4(uint32_t x_) : x(x_), y(x_), z(x_), w(x_)
{
}
...
Uint4::Uint4(const Float4& v) : x(uint32_t(v.x)), y(uint32_t(v.y)), z(uint32_t(v.z)), w(uint32_t(v.w))
{
}
...
Int2::Int2(const Float2& v) : x(int32_t(v.x)), y(int32_t(v.y))
{
}

Int2::Int2(const Uint2& v) : x(int32_t(v.x)), y(int32_t(v.y))
{
}
...
Int3::Int3(const Float3& v) : x(int32_t(v.x)), y(int32_t(v.y)), z(int32_t(v.z))
{
}

Int3::Int3(const Uint3& v) : x(int32_t(v.x)), y(int32_t(v.y)), z(int32_t(v.z))
{
}
...
Int4::Int4(const Float4& v) : x(int32_t(v.x)), y(int32_t(v.y)), z(int32_t(v.z)), w(int32_t(v.w))
{
}

Int4::Int4(const Uint4& v) : x(int32_t(v.x)), y(int32_t(v.y)), z(int32_t(v.z)), w(int32_t(v.w))
{
}
