...
typedef Microsoft::WRL::ComPtr<IDxcCompiler3> IDxcCompiler3Ptr;
...
typedef Microsoft::WRL::ComPtr<IDxcCompilerArgs> IDxcCompilerArgsPtr;
typedef Microsoft::WRL::ComPtr<IDxcUtils> IDxcUtilsPtr;
typedef Microsoft::WRL::ComPtr<IDxcResult> IDxcResultPtr;
