...
namespace SettingsCompiler
{
    ...
    [AttributeUsage(AttributeTargets.Field, Inherited = false, AllowMultiple = false)]
    public class DisplayInViewSpaceAttribute : Attribute
    {
        public readonly bool ViewSpace = true;

        public DisplayInViewSpaceAttribute(bool displayInViewSpace)
        {
            this.ViewSpace = displayInViewSpace;
        }

        public static bool DisplayInViewSpace(FieldInfo field)
        {
            DisplayInViewSpaceAttribute attr = field.GetCustomAttribute<DisplayInViewSpaceAttribute>();
            if(attr != null)
                return attr.ViewSpace;
            else
                return true;
        }
    }
    ...
    [AttributeUsage(AttributeTargets.Field, Inherited = false, AllowMultiple = false)]
    public class ShaderCompileTimeConstantAttribute : Attribute
    {
        public readonly bool CompileTime = true;

        public ShaderCompileTimeConstantAttribute(bool compileTime)
        {
            this.CompileTime = compileTime;
        }

        public static bool IsCompileTime(FieldInfo field)
        {
            ShaderCompileTimeConstantAttribute attr = field.GetCustomAttribute<ShaderCompileTimeConstantAttribute>();
            if(attr != null)
                return attr.CompileTime;
            else
                return false;
        }
    }
